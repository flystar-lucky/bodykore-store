...
const categories = [
  ...
  { name: 'Stores', link: routes.stores.path },
...
const Header = ({ productCat, dynamicPages }: HeaderParams) => {
  ...
  return (
    ...
    <nav className="sticky top-0 z-50">
      {/*Ad bar section*/}
      <div className="w-full h-auto bg-black text-center tracking-wide text-sm py-1 px-4">
        <span className="text-white font-semibold">
          ENJOY THE BLACK FRIDAY - 30% OFF ON SELECTED ITEMS
        </span>
      </div>

      {/*Navigation section*/}
      <div className="w-full bg-white sticky top-0">
        <div className="px-8 bg-white max-w-8xl m-auto">
          ...
          <div className='flex flex-row'>
            {/*BodyKore Logo*/}
            <div className='w-1/3 flex justify-start items-center xl:pl-16'>
              <div className="hidden xl:block">
                <Link href="/" passHref>
                  <img
                    ...
                    style={{ maxWidth: '170px', height: 'max-content' }}
                  />
                </Link>
              </div>
            </div>
            ...
            {/*Categories*/}
            <div className='w-1/3 flex justify-center items-center xl:pr-20'>
              <div className="hidden xl:block">
                <div className="flex gap-12">
                      ...
                      <ProductsDD
                        ...
                        subCategories={productCat.map((category) => ({
                          ...
                          options: category.subcategories.map((subcat) => {
                            ...
                            return {
                              text: subcat.name,
                              slug: `${routes.products.path}?category=${category.title}&subcategory=${subcat.name}`,
                            };
                          }),
                        }))}
                      />
                          ...
                          [
                            {
                              name: 'INFORMATIONAL',
                              options: [
                                { text: 'WeAreBodyKore', link: routes.about.path, newTab: '_self' },
                                {
                                ...
                                { text: 'Manuals', link: routes.manuals.path, newTab: '_self' },
                                { text: 'Videos', link: routes.videos.path, newTab: '_self' },
                                { text: 'Blog', link: routes.blog.path, newTab: '_self' },
                              ],
                            },
                          ],
                          [
                            {
                              ...
                              options: [
                                ...
                                { text: 'Financing', link: routes.financing.path, newTab: '_self' },
                                { text: 'My Account', link: '/auth/signin', newTab: '_self' },
                                {
                  ...
                  <div className="hidden flex-1 xl:block my-7 max-w-lg">
                    <div className="relative w-full flex gap-20 pt-1">
                      {categories.map((category, i) => (
                        <Link key={i} href={category.link} passHref>
                          <span
            ...
            <div className='w-1/3 flex justify-end items-center'>
              <div className="hidden xl:flex flex-1 gap-2 justify-end">
                <div className="flex justify-end gap-3 my-5 items-center">
                  ...
                  <Link href={'https://' + process.env.NEXT_PUBLIC_SHOPIFY_STORE_DOMAIN + '/account'} passHref>
