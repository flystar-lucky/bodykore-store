        ...
        {bgImage.map((b, i) => {
          return (
            <SplideSlide key={i} className="flex">
              ...
              {b.btn3d ? (
                <button className="flex items-center justify-center gap-2 absolute bg-white rounded-xl h-9 w-24 border-2 shadow-2xl mt-4 ml-4">
                  <Image src="/svg/3d.svg" width="24" height="24" />
                  <h1 className="text-black-373933 font-roboto text-sm">
                    View
                  </h1>
                </button>
              ) : null}
