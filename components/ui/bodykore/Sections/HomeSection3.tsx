    ...
    <>
      <section className="w-full max-w-7xl m-auto">
        <div className="flex flex-row justify-center">
          <div className="lg:w-1/4 pt-36 hidden lg:block">
          ...
          <div className="lg:w-3/4 lg:pr-24">
            <div className="lg:flex text-center font-bebas text-4xl lg:text-5xl font-bold italic pt-16 max-w-7xl m-auto pb-8">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <img
                          ...
                          alt=""
                        />
                        <p className="inline-block text-footnote light font-bebas text-2xl text-black-373933">
                          {a.question}
                        </p>
                      </div>
                    </button>
