...
export default function OurVision({ title1, title2, description, options }: OurVisionProps) {
    return (
        ...
        <section className="max-w-7xl m-auto lg:px-28 pb-28">
            <div id='belowBanner' className='w-full h-fit max-w-7xl m-auto pt-10'>
                <div className="text-center">
                    ...
                    <p className="px-20 pt-8 font-roboto text-black-1c2023">
                    {description}
                    </p>
                </div>
                <div className='flex flex-wrap justify-center items-center px-56 pt-20 gap-6 lg:gap-24 xl:gap-32 text-black'>
                    {options.map((o, i) => {
                        return (
                            <div className='flex flex-col pb-16 lg:pb-0 px-16 lg:px-0' key={i}>
