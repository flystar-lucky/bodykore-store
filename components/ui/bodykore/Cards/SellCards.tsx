                ...
                >
                  ...
                  <div className="px-3">
                    <div className="flex items-center h-20">
                      <div>
                        <h5 className="text-black-1c2023 font-roboto font-bold pt-5 w-32">
                          {item.title}
                        </h5>
                      </div>
                      <div className="flex justify-center items-center shadow-lg bg-white h-9 w-32 mt-6">
                        <h1 className="font-bebas italic font-bold text-red-bc2026 line-through pr-4">
                          {item.comparePrice !== undefined
                            ? `$${item.comparePrice}`
                            : null}
                        </h1>
                        <h1 className="font-bebas italic font-bold text-2xl text-black-373933">
                          ${item.price}
                        </h1>
                      </div>
                    </div>
                    ...
                    <button
                      className={`w-full h-12 mb-2 border-2 border-black-373933 rounded-md font-bebas ${
                        item.available
