            ...
            <div className="flex-1 h-0 pt-8 pb-4 overflow-y-auto flex flex-col justify-between">
              ...
              <div>
                ...
                <div className='flex justify-between px-8 py-5'>
                    <h1 className='text-2xl font-bebas font-bold italic text-black-373933' style={{ letterSpacing: '1px' }}>SUBTOTAL</h1>
                    <h1 className='text-2xl font-bebas font-bold italic text-red-bc2026' style={{ letterSpacing: '1px' }}>${cartTotal || "0"}</h1>
                </div>
                <div className='border-b border-gray-400 mx-8'></div>
              </div>
