    ...
    <>
      ...
      <div>
        <main className="w-full">
          ...
          <div className="flex justify-center pb-28 pt-20">
            ...
            images={[
              {
                ...
                title: 'INSPIRATION',
                description:
                  'Our ambassadors inform everything we do, from product and store design to how we show up in our communities.',
              },
              {
                img: '/svg/howWeWork2.svg',
                title: 'CLASSES AND EVENTS',
                description:
                  "Our ambassadors teach classes and host don't-miss events — online, in stores, and in your community.",
              },
              {
                img: '/svg/howWeWork3.svg',
                title: 'PRODUCT',
                description:
                  'Our ambassadors sweat hard in our gear, give us critical feedback, and collaborate on product collections.',
              },
            ]}
          />
